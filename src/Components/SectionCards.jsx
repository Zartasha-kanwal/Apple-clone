...
class Media {
  ...
  update(scroll, direction) {
    ...
    this.speed = (scroll.current - scroll.last) * 0.005; // Slow down more by reducing the speed factor
    this.program.uniforms.uTime.value += 0.04;
    this.program.uniforms.uSpeed.value = this.speed * 0.1; 
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.plane.scale.x =
      (this.viewport.width * (750 * this.scale)) / this.screen.width;
...
export default function SectionCards({
  ...
  return (
    <div
      className="w-full h-svh overflow-hidden cursor-grab active:cursor-grabbing"
      ref={containerRef}
    />
  );
}
